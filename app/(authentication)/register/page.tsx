...
function RegisterPage() {
   ...
   return (
      <div className="flex flex-col gap-10 h-screen">
         ...
         <form action={
         ...
         } className="flex flex-col w-[450px] gap-3 mx-auto items-center bg-white p-10 rounded-lg shadow-md shadow-blue-900 [&>*]:w-[380px]">
            ...
            <section className="flex flex-col gap-2">
               ...
               <p className="text-[#403D39] text-center">Already have an account? <Link href="/login" className="text-blue-900 font-semibold">Click</Link> </p>
            </section>
         </form>
      </div>
   );
