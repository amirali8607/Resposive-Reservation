      ...
      <div className="flex flex-col justify-center items-center">
         {
            diseases.map((item) => (
               <div key={item.id} className="flex flex-col gap-4 w-full">
                  <main className="flex flex-col items-center gap-2 rounded-lg bg-white dark:bg-[#151c2c] p-6">
                     <Image src={item.image!} className="size-60 rounded-md object-cover" alt="" width={100} height={100} />
                     <h1 className="text-3xl font-bold">{item.title}</h1>
                  </main>
                  <main className="flex flex-col items-center gap-2 rounde bg-white dark:bg-[#151c2c] p-6">
                  ...
                  <main className="flex flex-col rounded-lg bg-white dark:bg-[#151c2c] p-6 gap-2">
