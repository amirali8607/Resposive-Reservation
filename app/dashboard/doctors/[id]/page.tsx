      ...
      <div className="flex flex-col justify-center items-center">
         {
            doctorInfo.map((item) => (
               <div key={item.id} className="flex flex-col gap-4 w-full">
                  <main className="flex flex-col items-center gap-2 rounded-lg bg-white dark:bg-[#151c2c] transition-all p-6">
                  ...
                  <main className="flex flex-col gap-2 rounded-lg bg-white dark:bg-[#151c2c] transition-all p-6">
