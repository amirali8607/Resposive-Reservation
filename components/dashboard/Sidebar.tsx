...
export default async function Sidebar() {
   ...
   const findProfile = await prisma.user.findFirst({
      where: {
         id: session?.user.id
      }
   })
   return (
      <div className="flex flex-col bg-white w-[225px] px-4 py-3 gap-2">
         ...
         <section className="flex flex-col gap-0">
            ...
            <main className="flex gap-1 items-center p-3 w-full justify-start rounded-md hover:bg-blue-900/80 transition-all duration-150">
               <svg
            ...
            <main className="flex gap-1 items-center p-3 w-full justify-start rounded-md hover:bg-blue-900/80 transition-all duration-150">
               ...
               <Link href="/dashboard/doctors" className="text-sm">
                  Doctors
               </Link>
            ...
            <main className="flex gap-1 items-center p-3 w-full justify-start rounded-md hover:bg-blue-900/80 transition-all duration-150">
               ...
               <Link href="/dashboard/diseases" className="text-sm">
                  Diseases
               </Link>
            </main>
         </section>
